...
function OfflineNotice() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[9999] bg-rose-600 text-white text-xs font-semibold py-2 px-4 text-center shadow-md flex items-center justify-center gap-2 pointer-events-none">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 5.636a9 9 0 010 12.728m0 0l-2.829-2.829m2.829 2.829L21 21M15.536 8.464a5 5 0 010 7.072m0 0l-2.829-2.829m-4.243 4.243a9 9 0 01-2.828-6.364m0 0l2.828 2.828m-2.828-2.828L3 3m6.364 6.364a5 5 0 017.072 0" />
      </svg>
